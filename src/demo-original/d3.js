...
import { Case, Stack, TitleDivider, Loader } from '../components/Layout';
import { buttonCSS, buttonOutlineCSS } from '../components/Button';
import { css } from 'styled-components/macro';
import { mailPattern, fetchFakeLottery } from '../utils';
...
export default function Demo3() {
  return (
    <section>
      <TitleDivider>#3 Error Handling</TitleDivider>
        ...
        <div>
          <div css={fieldCSS.field}>
            ...
            <p>
              ...
              <span id="emailHint" css={fieldCSS.hint}>
